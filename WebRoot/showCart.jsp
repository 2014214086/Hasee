  ...
  <body>
   ...
   <div class="top">
	...
	<c:if test="${not empty sessionScope.user}">
 	...
 	<a href="order.jsp.jsp">修改密码</a>|
 	<a href="password.jsp">查看订单</a>|
  	</c:if>
   ...
   <div class="top-mid">
	...
	<span style="float:left;"><img src="images/cart.png" style="height:60px;margin-top:20px; margin-left:20px; border-left:1px solid black;"></span>
	</div>
   ...
   <% CartDao dao=new CartDao();
      ...
      request.setAttribute("cartList",dao.SelectCart(uid));
      int a=0;
      double sum=0;
   %> 
   ...
   <div style="width:1268px; margin-left:118px; text-align:center; margin-top:0px; line-height:150px;">
         ...
         <a href="index.jsp">您的购物车是空的，请先选购商品></a>
    	 </c:if>
         ...
         <ul class="goods_list">
		      ...
		      <li>
		         <div style="width:1266px;  line-height:120px; text-align:center;">
		          <div style="width:560px; height:120px; border-left:1px solid #ccc; border-bottom:1px solid #ccc; float:left;">
		          ...
		          <div style="width:175px; height:120px; border-left:1px solid #ccc; border-bottom:1px solid #ccc; float:left;">
		          	${goods.price}
		          </div>
		          <div style="width:175px; height:120px; border-left:1px solid #ccc; border-bottom:1px solid #ccc; float:left;">
		          	${goods.quantity}
		          ...
		          <div style="width:175px; height:120px; border-left:1px solid #ccc; border-bottom:1px solid #ccc;  border-right:1px solid #ccc; float:left;">
		          	<a href="CartServlet?flag=delete&flag1=<%out.print(uid);%>&flag2=${goods.goodsid}">删除</a>
		          </div>
		          </div>
		      </li>                  
		       </c:forEach>
		       ...
		       <div style="width:1266px; line-height:50px; color:white; text-align:center;">
		       	  <div style="width:1089px; background-color:#DDDDDD; height:50px;float:left;">
		       	  
		       	  <span style="font-size:25px; color:red;">总价：<%out.print(sum); %>元</span>
		       	  
		       	  </div>
		       	  <a href="OrderServlet?flag=make&money=<%out.print(sum); %>" style="color:white;">
		          <div style="width:177px; background-color:#F33C11; height:50px;float:left;">
		          	结算
		          </div>
		          </a>
		          </div>
